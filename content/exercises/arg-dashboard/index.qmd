...
git clone git@github.com:munch-group/arg-dashboard
...
Install the packages:
    ...
    pixi add arg-dashboard

Download the notebook to by running this command in your `arg-dashboard` folder:
...
Open the notebook in VS Code and execute the first cell.
